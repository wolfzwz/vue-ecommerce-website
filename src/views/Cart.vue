...
<script>
    ...
    export default{
        ...
        computed:{
          ...
          //判断已选择的商品数和购物车总商品数是否相等,checkedCount和cartList改变，checkAllFlag将会改变
          checkAllFlag(){
